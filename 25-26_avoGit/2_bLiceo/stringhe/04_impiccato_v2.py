...
while tempts > 0 and str_user_word != secret_word:
    ...
    if user_char in user_tempts_wrong or user_char in user_tempts_right:
        print(f"FAI ATTENZIONE< HAI GIÃ INSERITO QUESTA LETTERA!")

    elif user_char in secret_word:
        user_tempts_right.append(user_char)
