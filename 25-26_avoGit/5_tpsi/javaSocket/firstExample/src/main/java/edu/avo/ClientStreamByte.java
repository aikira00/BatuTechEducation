...
public class ClientStreamByte {
    public static void main(String[] args) {
        try {
            ...
            System.out.println("Mando un numero di 1 byte al server " + num);
            out.write(num);

            num = 320; // binario 101000000
            System.out.println("Mando un numero di 1 byte al server ma molto grande al server: " + num);
            out.write(num);
