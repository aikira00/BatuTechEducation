...
public class multiRequestServer extends Thread {
    ...
    Map<String, multiRequestServer> listaServer;
    String id_client;

    public multiRequestServer(Socket s, Map<String, multiRequestServer> lista, String id_client){
        super();
        this.s = s;
    ...
    private void accept_connection() {
        try {
            System.out.println(id_client + " ACCEPT ");
            while (active) {
                System.out.println(id_client + " WHILE ACTIVE ");
                PrintWriter out = new PrintWriter(s.getOutputStream(), true);
                BufferedReader in = new BufferedReader(new InputStreamReader(s.getInputStream()));
                String input_string;
                while ((input_string = in.readLine()) != null) {
                    System.out.println(id_client + " INVIATO " + input_string);
