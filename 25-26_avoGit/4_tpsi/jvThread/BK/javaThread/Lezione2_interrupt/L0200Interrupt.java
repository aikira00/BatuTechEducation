public class L0200Interrupt extends Thread {
   ...
   public void run() {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Thread principale: " + Thread.currentThread().getName() +  " - Il thread è stato avviato.");
        ...
        myThread.interrupt(); // invio segnale al thread di interrompersi
