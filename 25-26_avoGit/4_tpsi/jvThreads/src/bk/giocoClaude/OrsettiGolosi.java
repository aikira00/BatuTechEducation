...
public class OrsettiGolosi extends JFrame {
    ...
    private class ThreadOrsetto implements Runnable {
        ...
        private Caramella trovaCamellaPiuVicina(Orsetto orsetto) {
            ...
            synchronized (caramelle) {
                // Creazione di una copia dell'ArrayList per evitare ConcurrentModificationException
                ArrayList<Caramella> caramelleCopy = new ArrayList<>(caramelle);

                for (Caramella caramella : caramelleCopy) {
