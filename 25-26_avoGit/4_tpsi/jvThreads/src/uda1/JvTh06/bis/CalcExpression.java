...
public class CalcExpression extends Thread {
    private int a;
    private int b;
    private int c;
    private double res;

    public CalcExpression(int a, int b, int c){
        this.a = a;
        this.b = b;
        this.c = c;
    }
    ...
    public void run(){
        ...
        Yellow yellow = new Yellow(this.getA(),this.getB(),this.getC());
        yellow.setName("Giallo");
        yellow.start();
        Green green = new Green(this.getA(),this.getB(),this.getC());
        green.setName("Verde");
        green.start();
        try{
            yellow.join();
